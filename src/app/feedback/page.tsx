...
import { ArrowLeft, CheckCircle2, Loader2, Upload, Star, Award } from "lucide-react";
import { createClient } from "@/lib/supabase";
import ImageUploadField from "@/components/admin/ImageUploadField"; // We can reuse the admin uploader for public if the bucket allows, or we just rely on standard file input. The `ImageUploadField` requires specific props but it's easier to build a quick public one.
            ...
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
                <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg p-10 text-center border border-gray-100">
                    ...
                    <p className="text-gray-600 mb-8 leading-relaxed">
                        Your success story means the world to us. It has been successfully submitted and will inspire countless other students on their journey.
                    </p>
                    <Link href="/" className="bg-[#a60303] text-white px-8 py-3.5 rounded-full font-bold hover:bg-[#800202] transition-colors inline-block">
                        Return to Homepage
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6">
            <div className="max-w-2xl mx-auto">
                <Link href="/" className="inline-flex items-center gap-2 text-gray-500 hover:text-[#a60303] font-medium transition-colors mb-8">
                            ...
                            >
                                {status === "submitting" ? (
                                    <>
                                        ...
                                        {isUploadingImage ? "Uploading Photo..." : "Submitting Story..."}
                                    </>
