                ...
                <div className="flex items-center justify-between gap-4 mb-6">
                    ...
                    <div className="relative" ref={filterRef}>
                        <button
                            ...
                            className={cn(
                                ...
                                isFilterOpen || activeFilterCount > 0
                                    ? "bg-[#a60303] text-white border-[#a60303]"
                        ...
                        >
                            ...
                            Filters
                            {activeFilterCount > 0 && (
                                <span className="w-5 h-5 rounded-full bg-white text-[#a60303] text-[11px] font-black flex items-center justify-center leading-none">
                                    {activeFilterCount}
                                </span>
                            )}
                            <ChevronDown
                            ...
                            <div className="absolute right-0 top-full mt-2 z-30 bg-white rounded-2xl border border-gray-200 shadow-2xl shadow-gray-200/60 p-5 w-[min(580px,90vw)]">
                                    ...
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        {selectedCategories.length > 0 && (
                                            <button
                                                ...
                                                className="text-[10px] font-bold text-[#a60303] hover:underline"
                                            >
                                                Clear
                                            </button>
                                        )}
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    selectedCategories.includes(cat)
                                                        ? "bg-[#a60303] text-white border-[#a60303]"
                                                        : "bg-gray-50 text-gray-600 border-gray-200 hover:border-[#a60303]/40 hover:text-[#a60303]"
                                                )}
                                            >
                                                {cat}
                                            </button>
                                        ...
                                        {[4.5, 4, 3.5].map(rating => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    minRating === rating
                                                        ? "bg-red-50 border-[#a60303] text-[#a60303]"
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                    ...
                                    <button
                                        ...
                                        className="px-5 py-2 bg-[#a60303] text-white text-xs font-black rounded-xl hover:bg-[#8a0202] transition-colors"
                                    >
                                        Done
                                    </button>
                                </div>
                ...
                {(selectedCategories.length > 0 || minRating !== null) && (
                    <div className="flex flex-wrap gap-2 mb-6">
                        {selectedCategories.map(cat => (
                            <span
                                key={cat}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-red-50 border border-red-100 text-[#a60303] text-xs font-bold"
                            >
                                {cat}
                        ...
                        {minRating !== null && (
                            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-red-50 border border-red-100 text-[#a60303] text-xs font-bold">
                                ★ {minRating}+ stars
